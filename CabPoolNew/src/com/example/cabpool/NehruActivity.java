...
public class NehruActivity extends ActionBarActivity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
	     ...
	     ArrayAdapter<String>adapterNew1 = new ArrayAdapter<String>(NehruActivity.this,
		...
		spinner = (Spinner)findViewById(R.id.spinner);
	     ...
	     ArrayAdapter<String>adapterNew = new ArrayAdapter<String>(NehruActivity.this,
		 ...
		 submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				seats=spinner2.getSelectedItem().toString();
			     ...
			     {
			    	 	Driver.put("Destination", "Nehru Place");
			     ...
			     {
			    	 	Passenger.put("Destination", "Nehru Place");
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		{
			ArrayAdapter<String>adapterIfBike = new ArrayAdapter<String>(NehruActivity.this,
